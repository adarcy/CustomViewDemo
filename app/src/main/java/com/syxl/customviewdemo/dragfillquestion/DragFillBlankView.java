...
public class DragFillBlankView extends RelativeLayout implements View.OnDragListener,View.OnLongClickListener{
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.layout_drag_fill_blank, this);
    ...
    public void setData(String originContent, List<String> optionList, List<AnswerRange> answerRangeList) {
        if (originContent == null || originContent.isEmpty() || optionList == null || optionList.isEmpty()
        ...
        if (llOption.getChildCount() < 1) {
            ...
            for (int i = 0; i < optionList.size(); i++) {
                ...
                button.setText(optionList.get(i));
                button.setOnLongClickListener(this);
                list.add(button);
            }
            for (int i = 0; i < list.size(); i++) {
                llOption.addView(list.get(i));
            }
        }else {
            // 不显示已经填空的选项
        ...
        for (AnswerRange answerRange : this.answerRangeList) {
            ...
            content.setSpan(colorSpan, answerRange.start, answerRange.end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
